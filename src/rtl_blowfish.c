...
#define swap(r,l,t) do { t = l; l = r; r = t; } while (0)
#define ITERATION(l,r,t,pval) do { l ^= keystruct->p[pval]; F(l,t); r^= t; swap(r,l,t); } while (0)
...
void rtl_blowfish_key_setup(const uint8_t user_key[], rtl_blowfish_key_t *keystruct, size_t len)
{
	...
	for (idx = 0; idx < 18; idx += 2) {
		rtl_blowfish_encrypt(block,block,keystruct);
