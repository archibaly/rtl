...
void rtl_json_add_item_to_objectcs(rtl_json_t *object, const char *string, rtl_json_t *item);
...
/* update array items. */
void rtl_json_insert_item_in_array(rtl_json_t *array, int which, rtl_json_t *newitem);	/* shifts pre-existing items to the right. */
void rtl_json_replace_item_in_array(rtl_json_t *array, int which,
									rtl_json_t *newitem);
void rtl_json_replace_item_ino_bject(rtl_json_t *object, const char *string,
									 rtl_json_t *newitem);
